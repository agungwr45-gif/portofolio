...
function ArchitecturalSphere() {
  ...
  useFrame((state) => {
    if (meshRef.current) {
      ...
      // Parent group is scaled by 3.5, sphere radius is 1. World radius = 3.5.
      // We limit local position so world position (local * 3.5) never exceeds viewport edge minus radius.
...
export default function BlendedPortfolio() {
  const projects: Project[] = [
    ...
    { title: "bettercalljack.lab", desc: "Laboratorium eksperimental di Instagram yang mengeksplorasi sinergi antara kreativitas visual dan algoritma media sosial.", img: "/assets/preview-bettercalljack.lab.jpg", links: [{ label: "Instagram", type: "ig", url: "https://instagram.com/bettercalljack.lab" }] },
